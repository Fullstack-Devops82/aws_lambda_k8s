...
#server = 'stefuna.hello_server.HelloServer'

# The module path of the worker class
worker = 'displaySecondMessage_worker.DisplaySecondMessageWorker'

# The base name of the server that will be combined with host and pid
# and used when requesting tasks from AWS.
name = 'DisplaySecondMessageEnd'

# Set the ARN for the activity that this server will work on.
activity_arn = 'arn:aws:states:us-east-2:912778368198:activity:displaySecondMessage'
